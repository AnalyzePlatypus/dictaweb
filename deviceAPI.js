...
var data = {
    ...
    SH: window.screen.height * window.devicePixelRatio,
    SW: window.screen.width * window.devicePixelRatio,
    SHN: window.screen.height,
    SWN: window.screen.width,
    SR: window.devicePixelRatio,
    GPU: rd,
    TS: ts,
    SPL: (endTime - startTime),
};

var result
var senddata = JSON.stringify(data);
var domain = "https://theapicompany.com/deviceAPI8.php"
